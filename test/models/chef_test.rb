...
class ChefTest < ActiveSupport::TestCase
    def setup
        @chef = Chef.new(chefname: "john", email: "johm@example.com")
    end
    ...
    test "email validation should reject valid addresses" do
        valid_addresses = %w[user@eee.com R_TDD-DS@eee.hello.org user@example.com first.last@eem.ou laura+joe@monk.cm]
